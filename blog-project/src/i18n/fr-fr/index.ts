...
export default {
  ...
  menu:{
    ...
    PublishDate:'Date de sortie',

  }, myblogmain: {
    title:'Auteur de la chanson folklorique de Çanakkale',
    detail:'Cliquez pour accéder à l \'essai que j \'ai préparé sur la base de mes recherches sur la chanson folklorique de Çanakkale et son auteur.'
  },
  months: {
    january: 'Janvier',
    february: 'Février',
  ...
  footer:{
    copyright:'Copyright 2024 - Polyglot Thinker. Tous droits réservés.',
  },
  canakkale:{
    title:'Qui est l’écrivain du Peuple de Çanakkale ?',
    p1:'Le nom de l’écrivain du peuple de Çanakkale est « İhsan OZANOĞLU » Il est noté par Muzaffer SARIÖZEN qui est l’un des noms les plus importants dans la musique turque du peuple, ressource du Folk de Çanakkale est İhsan OZANOĞLU de KASTAMONU et aux premiers enregistrements ont été enregistrés à 1923 également trouvé qu’avec la voix de Marika PAPAGİKA.Aussi pour la première fois By Bogos KIRECCIYAN transformé en disque avec chant turc. Et en tant que compositeur qui est Kemani KEVSER, il est dédié à « Anthem and Folk of the Çanakkale » est couvert dans İstanbul Ottoman période Music à appliquer et centre de recherche.',
    p2:'Parlons un peu de la vie d’İhsan OZANOĞLU.Il est né au 15 Nisan 1907 dans le quartier de Kastamonu Honsalar. En tant que dernier représentant des Aşıklık traditionnels de Kastamonu İhsan OZANOĞLU, il n’était pas seulement poète de Saz en même temps qu’homme de littérature, professeur, journaliste, musique et religion.Son père s’appelle Aşıkoğlu Ahmet, le chef de la loge de Şabaniyye, et sa mère, Hafize Emine.',
    p3:'Il a commencé à écrire des poèmes dans son enfance. İhsan Ozanoğlu, avec son maître Aşık Hasan a obtenu la référence, puis s’est joint au Conseil Aşıklar. Il a également pris des leçons de musique et de mélodie en plus de son maître Aşık Hasan, il y avait Karakadıoğlu Rıfat et Kemal İlerici.',
  ...
  karsli_aktor:{
    title:'Qui est Ozan Çobanoğlu ? ',

    title_main:' Bonjour, aujourd\'hui j\'aimerais vous parler d\'Ozan Çobanoğlu, un acteur de KARS.',

    p1:'Né le 6 février 1980 à Kars, il est un acteur turc. Il est le fils d\'Aşık Murat Çobanoğlu.Il est diplômé du département de théâtre du conservatoire d\'État de l\'université Hacettepe en 2004. Après avoir travaillé dans les théâtres d\'État d\'Izmir et d\'Ankara, il est devenu membre permanent du théâtre d\'État de Konya en 2005. ',

    p2:'Il a travaillé comme acteur principal dans la série télévisée Tek Turkey sur Samanyolu TV. Il a tenu son premier rôle dans l\'œuvre intitulée Secrets World.Il a tenu son dernier rôle dans la série Arka Sokaklar, qu\'il joue toujours.',

    p3:'Il a épousé sa femme, Ezgi Sertel, en 2016 et a eu 3 enfants de ce mariage. Ils s\'appellent respectivement Doruk Çobanoğlu, Tibet Çobanoğlu et Mert Çobanoğlu',

    p4:'Parlons de sa filmographie',
